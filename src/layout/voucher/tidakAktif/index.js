...
export default function index(props) {
    ...
    const handleStatusVoucher = async () => {
        ...
        actionSheetRef.current?.setModalVisible(false);
        setTimeout(async () => {
            Service.updateStatusVoucher(idPromo, 1).then(res => {
    ...
    const getVoucherApi = async () => {
        Service.getVoucherTidakAktif(reduxSeller)
            .then((res) => {
                if (res.status === 200) {
    ...
    return (
        <Fragment>
            ...
            <ActionSheet containerStyle={styles.actionSheet} ref={actionSheetRef}>
                <ActionSheetPromotion status={1} idPromo={idPromo} actionSheetRef={actionSheetRef} typeSelected={typeSelected} isEnabled={isEnabled} setIsEnabled={setIsEnabled} setspinner={setspinner} getVoucherApi={getVoucherApi} setitemPressed={setitemPressed} handleEditVoucher={handleEditVoucher} />
                {/* <View style={styles.headerModal}>
                    <Text style={styles.actionSheetTitle}>Informasi voucher</Text>
                ...
                <View style={styles.modalLine}>
                    ...
                    <Text style={Style.font_14}>Status</Text>
                    <View style={styles.abc}>
                        <Text style={Style.font_14}>{isEnabled ? "Aktif" : "Tidak Aktif"}</Text>
                        <Switch
                ...
                <TouchableOpacity style={styles.modalLine} onPress={() => handleEditVoucher()}>
                    ...
                    <Text style={[Style.font_14]}>Edit</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.modalLine} onPress={() => handleDelete() & typeSelected(idPromo)}>
                    ...
                    <Text style={Style.font_14}>Hapus</Text>
                </TouchableOpacity> */}
            </ActionSheet>
            ...
            <AwesomeAlert
                ...
                showProgress={false}
                // title="Ha"
                message="Anda ingin mengaktifkan voucher?"
